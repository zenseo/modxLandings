<?php
/**
 * @modxDescription CodeMirror 2.2.0-pl plugin for MODx Revolution
 * @modxCategory    
 * @modxEvent       OnChunkFormPrerender:0
 * @modxEvent       OnDocFormPrerender:0
 * @modxEvent       OnFileEditFormPrerender:0
 * @modxEvent       OnPluginFormPrerender:0
 * @modxEvent       OnRichTextEditorRegister:0
 * @modxEvent       OnSnipFormPrerender:0
 * @modxEvent       OnTempFormPrerender:0
 */
/**
 * @var modX $modx
